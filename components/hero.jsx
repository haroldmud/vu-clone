          ...
          <div className="w-full md:absolute flex justify-center top-[16rem]">
            <div className="md:w-[82rem] md:h-[8rem] h-[6rem] w-full bg-white md:flex">
                ...
                <div className="flex justify-center">
                  <div className="w-10/12 border-b border-white flex text-white ">
                    <input
                      placeholder="Search..."
                      type="text"
                      className="outline-none w-full placeholder:text-white placeholder:text-3xl placeholder:font-thin bg-blue"
                    />
                    <button className="text-[2.5rem] mb-2">
                      <CiSearch />
                    </button>
                  </div>
                </div>
              ...
              <div className=" md:w-[41.2%] flex flex-col justify-center">
                ...
                >
                  <p className="my-auto md:text-4xl text-2xl ">
                    About VU Amsterdam
                  </p>
