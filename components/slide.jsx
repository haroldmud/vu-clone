...
export default function Slide(){
  return (
    <section className="flex relative md:justify-center bg-back overflow-x-hidden">
        <section className="bg-white flex flex-col w-[98.5%] justify-center md:h-[70rem] ">
          <div className="flex justify-center">
          <h1 className="text-orange md:text-6xl text-5xl font-thin md:w-10/12 w-11/12 mt-12">We are VU Amsterdam</h1>
          </div>
          <div className="overflow-x-scroll flow mt-16"> 

                              <div className="flex w-[130rem]  gap-12 md:pb-0 pb-16">
                                  <div className="flex flex-col gap-8 cursor-pointer w-[289px] ">
                                    ...
                                    <div className="">
                                      <p className="text-3xl font-thin text-orange">Vrije Schrijver (Writer in Residence)</p>
                                    </div>
                                    <div className="text-2xl flex justify-between pr-2">
                                      <p>Read more</p>
